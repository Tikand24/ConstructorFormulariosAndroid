...
public class KardexActivity extends AppCompatActivity implements View.OnClickListener{

    LinearLayout contenedorKardex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contenedorKardex = (LinearLayout) findViewById(R.id.contenedorKardex);
        ...
        for (int i=0; i<bloquesFormato.size();i++){
            ...
            contenedorKardex.addView(bloque);
            ...
            for (int j=0; j<bloquesFormato.get(i).getPreguntas().size(); j++){
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("desplegable")){
                     ...
                     */
                    contenedorKardex.addView(pregunta);
                    contenedorKardex.addView(select);
                }
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("multiple seleccion")){
                    ...
                    for (int k=0; k<bloquesFormato.get(i).getPreguntas().get(j).getRespuestas().size();k++){
                        ...
                        contenedorKardex.addView(check);
                    }
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("fecha")){
                        ...
                        public void onFocusChange(View v, boolean b) {
                            ...
                            if (v.getId()==fecha.getId()){
                                if (b){
                                    ...
                                    DatePickerDialog d = new DatePickerDialog(KardexActivity.this,dpd,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH));
                                    d.show();
                                }
                            }
                        }
                    ...
                    contenedorKardex.addView(pregunta);
                    contenedorKardex.addView(fecha);
                }
