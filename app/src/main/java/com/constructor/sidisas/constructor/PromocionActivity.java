...
public class PromocionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    LinearLayout contenedorPromocion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contenedorPromocion = (LinearLayout) findViewById(R.id.contenedorPromocion);
        ...
        for (int i=0; i<bloquesFormato.size();i++){
            ...
            contenedorPromocion.addView(bloque);
            ...
            for (int j=0; j<bloquesFormato.get(i).getPreguntas().size(); j++){
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("desplegable")){
                     ...
                     */
                    contenedorPromocion.addView(pregunta);
                    contenedorPromocion.addView(select);
                }
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("multiple seleccion")){
                    ...
                    for (int k=0; k<bloquesFormato.get(i).getPreguntas().get(j).getRespuestas().size();k++){
                        ...
                        contenedorPromocion.addView(check);
                    }
                ...
                if (bloquesFormato.get(i).getPreguntas().get(j).getTipo().equals("fecha")){
                        ...
                        public void onFocusChange(View v, boolean b) {
                            ...
                            if (v.getId()==fecha.getId()){
                                if (b){
                                    ...
                                    DatePickerDialog d = new DatePickerDialog(PromocionActivity.this,dpd,c.get(Calendar.YEAR),c.get(Calendar.MONTH),c.get(Calendar.DAY_OF_MONTH));
                                    d.show();
                                }
                            }
                        }
                    ...
                    contenedorPromocion.addView(pregunta);
                    contenedorPromocion.addView(fecha);
                }
